        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form method="POST" action="{{ route('admin.noticias.update', $noticia->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content_es" rows="10" required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-parlamento-azul">{{ old('content_es', $noticia->content_es) }}</textarea>
                </div>
